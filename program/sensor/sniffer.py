...
def sniffer():
    ...
    while True:
        ...
        output.write('\nEthernet Frame:')
        output.write(TAB_1 + 'Destination: {}, Source: {}, Protocol: {}'.format(dest_mac, src_mac, eth_proto))
        ...
        if eth_proto == 8:
            ...
            output.write(TAB_2 + 'Protocol: {}, Source, {}, Target: {}'.format(proto, src, target))
            ...
            #TCP
                ...
                output.write(TAB_2 + 'Source Port: {}, Destination Port: {}'.format(src_port, dest_port))
            ...
            #UDP
                ...
                output.write(TAB_2 + 'Source Port: {}, Destination Port: {}, Length: {}'.format(src_port, dest_port, length))     
            else:
